...
export default function App() {
  ...
  return (
    ...
    <NavBar>
      ...
      <Main>
        <Box>
          <AnimeList animes={animes} oneSelectedAnime={handleSelectedAnime} />
        </Box>
        <Box>
...
function AnimeList({ animes, oneSelectedAnime }) {
  return (
    <ul className="list list-anime">
      {animes.map((anime) => (
        <Anime key={anime.mal_id} anime={anime} oneSelectedAnime={oneSelectedAnime} />
      ))}
    </ul>
  );
}

function Anime({ anime, oneSelectedAnime }) {
  return (
    <li onClick={() => oneSelectedAnime(anime.mal_id)}>
